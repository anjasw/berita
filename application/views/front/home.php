	...
	<div class="main-body">
		<div class="wrap">
			<div class="col-md-8 content-left">
				...
				<div class="articles">
					<header>
						<h3 class="title-head">Perbincangan Dunia	</h3>
					</header>

          <? foreach ($all->result() as $a ) {?>
            <div class="article">
  						<div class="article-left">
  							<a href="<? echo base_url().'news/detail/'.$a->idberita.'/'.$a->seolink?>"><img src="<? echo base_url().'assets/images/'.$a->image?>"></a>
  						</div>
  						<div class="article-right">
  							<div class="article-title">
  								...
  								<a class="title" href="<? echo base_url().'news/detail/'.$a->idberita.'/'.$a->seolink?>"><? echo $a->judulberita ?></a>
  							</div>
  							<div class="article-text">
  								<p><? echo substr(strip_tags($a->isiberita), 0 , 200) ?></p>
  								<a href="<? echo base_url().'news/detail/'.$a->idberita.'/'.$a->seolink?>"><img src="<? echo base_url()?>front/images/more.png" alt="" /></a>
  								<div class="clearfix"></div>
  							</div>
  						</div>
  						<div class="clearfix"></div>
				...
				<div class="list_vertical">
					 ...
					 <div class="popular-news">
						...
						<div class="popular-grids">
							...
							<div class="popular-grid">
								<a href="single.html"><img src="<? echo base_url()?>front/images/popular-1.jpg" alt="" /></a>
								<a class="title" href="single.html">It is a long established fact that a reader will be distracted</a>
		...
		<div class="footer-top">
			<div class="wrap">
				<div class="col-md-4 col-xs-6 col-sm-4 footer-grid">
					...
					<p>Kami ada untuk mempermudah user dalam mendapatkan berita terupdate/terbaru yang sedang di perbincang oleh banyak orang.</p>
					<p></p>
				</div>
				<div class="col-md-4 col-xs-6 col-sm-2 footer-grid">
				...
				<div class="col-md-4 col-xs-12 footer-grid">
					...
					<span class="hq">Kantor Kami</span>
					<address>
						<ul class="location">
							<li><span class="glyphicon glyphicon-map-marker"></span></li>
							<li>Sindang Barang, Bogor Barat, Jawa Barat</li>
							<div class="clearfix"></div>
						</ul>
						<ul class="location">
						...
						<ul class="location">
							...
							<li><a href="#">anjaswicaksana122@gmail.com</a></li>
							<div class="clearfix"></div>
						</ul>
					</address>
				</div>
		...
		<div class="footer-bottom">
			<div class="wrap">
				<div class="copyrights col-md-6">
					<p> &copy 2017 November By Anjas Wicaksana</a></p>
				</div>
