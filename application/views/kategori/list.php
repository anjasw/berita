            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h3> <center>Data Kategori Berita</center></h3>
                            <div class="row">
                              <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                              <select class="form-control" name="field">
                                                <option value="jenisberita">Nama Kategori</option>
                                                <option value="__createdby">Dibuat Oleh</option>
                                              </select>
                                            </div>
                                        </div>
                                    </div>
                              ...
                              <div class="col-lg-2">
                                <a class="pull-right" href="<? echo base_url() ?>kategori/add">
                              ...
                              <div class="col-lg-2">
                                <a class="pull-right" href="<? echo base_url() ?>kategori/export">
                                  <button class="btn bg-blue waves-effect">
                                    <i class="material-icons">add</i>
                              ...
                              <div class="col-lg-2">
                                <a class="pull-right" href="<? echo base_url() ?>kategori/excel">
                                  <button class="btn bg-blue waves-effect">
                                    <i class="material-icons">add</i>
																				...
																				if($data->num_rows()>0) {
																					...
																					foreach ($data->result() as $row ){
																						echo"<tr>
																							...
																							<td><a href='".base_url()."kategori/edit/$row->idjenisberita' class='btn blue'><i class='material-icons'>edit</i></a>
																							<a onclick='return is_delete()' href='".base_url()."kategori/delete/$row->idjenisberita' class='btn red'><i class='material-icons'>delete</i></a>
																							</td>
